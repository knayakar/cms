...
<?php  // Retrieve user data from DB
    ...
    if(isset($_GET['user_id'])) {
        ...
        $retrieve_user_data_query = "SELECT * FROM users WHERE user_id = $get_user_id";
...
<?php 
    ...
    if(isset($_POST['submit'])) {
        ...
        $update_user_query = "UPDATE users SET username = '$username', user_email = '$user_email', user_password = '$user_password', user_firstname = '$user_firstname', user_lastname = '$user_lastname', user_role = '$user_role', user_image = '$user_image' WHERE user_id = '$get_user_id'";
